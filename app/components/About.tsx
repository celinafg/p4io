      ...
      <div className={styles.aboutcont}>
        ...
        <div>
          <p>
            ...
            stuff that people actually use, no matter the hat Im wearing. My
            dream role is one where Im able to sit at the intersection of design
            and engineering - whether that means research, design, or code.
            <br />
            <br />
